...
### Korjattu
- **010-0044 vastaus korjattu**: Oikea vastaus oli virheellisesti C ("asuinvaltio tai kokopäivätyö"). Korjattu vastaukseksi A: "Uudella jäsenvaltiolla ei ole merkittäviä perusteita kieltäytyä konvertoimasta lupakirjaa." Selitys kirjoitettu vastaamaan oikeaa vastausta.
- **010-0085 vastaus korjattu**: Oikea vastaus oli virheellisesti A. Korjattu vastaukseksi D: "Tehdä kaikki kaarrot vasemmalle, ellei toisin ole ilmoitettu." Selitys päivitetty SERA.3225:n perussäännön mukaiseksi (kaarrot vasemmalle laskeutumista lähestyttäessä ja lentoonlähdön jälkeen, ellei muuta ole määrätty tai ilmoitettu).
- **020-0008 vastaus korjattu**: Oikea vastaus oli virheellisesti A ("kaikki vaihtoehdot oikein"). Korjattu vastaukseksi C: "Valita seosvipu täysin laihalle." Selitys: seosvipu vedetään täysin laihalle polttoaineensyötön katkaisemiseksi ja starttaamista jatketaan, jotta liekit imeytyvät moottoriin.
- **020-0036 vastaus korjattu**: Oikea vastaus oli virheellisesti B ("kaksi kertaa"). Korjattu vastaukseksi D: "Kerran." Selitys: yhden Otto-kierron aikana kukin venttiili avautuu kerran — imuventtiili imutahdilla ja pakoventtiili poistotahdilla.
- **020-0056 vastaus korjattu**: Oikea vastaus oli virheellisesti A. Korjattu vastaukseksi B: "Se voi aiheuttaa polttoaineen imeytymisen polttoainetankista kaasuttimeen, tehden seoksesta erittäin rikkaan." Selitys: ryyppypumppu on lukittava, jotta polttoainetta ei pääse virtaamaan hallitsemattomasti kaasuttimeen; auki jäänyt pumppu rikastaa seosta liikaa ja aiheuttaa epätasaista käyntiä.
- **030-0065 vastaus korjattu**: Oikea vastaus oli virheellisesti C ("33 % / 1,33"). Korjattu vastaukseksi B: "15 % tai kertoimella 1.15." Selitys: laskeutumisnopeus kasvaa massan neliöjuuren suhteessa, mutta koska jarrutusvoima (pyörien kitka) on verrannollinen painoon, massa supistuu pois — laskumatka on suoraan verrannollinen massaan, joten 15 % massalisäys pidentää matkaa noin 15 %.
- **030-0069 vastaus korjattu**: Oikea vastaus oli virheellisesti B ("92,44 in"). Korjattu vastaukseksi C: "94,01 in." Selitys laskettu uudelleen: polttoaine 30 US gal × 6 lb/US gal = 180 lb; kokonaismassa 2 055 lb, kokonaismomentti 193 193 lbxin → CG ≈ 94,01 in. Selitys rivitetty (\n) laskennan vaiheiden mukaisesti.
- **030-0071 vastaus korjattu**: Oikea vastaus oli virheellisesti A ("90 lbs"). Korjattu vastaukseksi B: "105 lbs." Selitys: kuormien kokonaismassa ilman matkatavaroita on 2 195 lb ja normaaliluokan suurin sallittu massa 2 300 lb, joten matkatavaraa voidaan kuormata 105 lb; tällä kuormalla myös massakeskipiste pysyy sallituissa rajoissa.
- **030-0077 vastaus korjattu**: Oikea vastaus oli virheellisesti C. Korjattu vastaukseksi A: "Pienempi kuin painekorkeus ja suunnilleen sama kuin tosikorkeus." Selitys: standardia matalampi lämpötila tekee ilmasta tiheämpää, jolloin tiheyskorkeus on painekorkeutta pienempi; A kuvaa tätä parhaiten. Kysymyksen tarkistuslippu (`needsReview`) poistettu.
- **040-0065 vastaus korjattu**: Oikea vastaus oli virheellisesti B ("hallusinaatio"). Korjattu vastaukseksi A: "Kangastus." Selitys: kangastus tarkoittaa todellisen aistiärsykkeen väärää tulkintaa, kun taas hallusinaatiossa havainto syntyy ilman todellista ulkoista ärsykettä. Kysymyksen tarkistuslippu (`needsReview`) poistettu.
- **040-0081 vastaus korjattu**: Oikea vastaus oli virheellisesti D. Korjattu vastaukseksi B: "Tapahtumat ja tilanteet, jotka aiheuttavat stressiä." Selitys: stressitekijät ovat tapahtumia ja tilanteita, jotka aiheuttavat ihmiselle stressiä — ne voivat olla fyysisiä, henkisiä tai emotionaalisia kuormitustekijöitä.
- **050-0079 vastaus korjattu**: Oikea vastaus oli virheellisesti B. Korjattu vastaukseksi A: "Ilmanpaine laskee, 8/8 pilvisyyttä, pilven alaraja pienenee ja huono näkyvyys." Selitys: lämpimän rintaman lähestyessä ja ylityksen yhteydessä ilmanpaine laskee, pilvisyys lisääntyy yhtenäiseksi 8/8:ksi, alaraja laskee ja näkyvyys heikkenee sateen ja matalan pilvisyyden vuoksi.
- **050-0093 korjattu**: Kysymys ei ole kuvakysymys — poistettu virheellinen liiteviittaus "(Liite LAPL/PPL 050-01)". Oikea vastaus oli virheellisesti B. Korjattu vastaukseksi C: "6 tuntia." Selitys: SWC-karttoja julkaistaan tyypillisesti 6 tunnin välein.
- **050-0096 selitys päivitetty**: Vastaus B oli jo oikein. Täsmennetty selitys: VOLMET-lähetys välittää ajantasaisia lentosäätietoja, tiedot päivittyvät tyypillisesti noin puolen tunnin välein; Suomessa VOLMET-palvelu poistettiin käytöstä vuonna 2023.
- **050-0099 vastaus korjattu**: Oikea vastaus oli virheellisesti B. Korjattu vastaukseksi D: "Kerran puolessa tunnissa." Selitys: ATIS uusitaan käytännössä usein noin puolen tunnin välein uusien rutiinisäätietojen yhteydessä; merkittävä muutos toiminnassa tai sääolosuhteissa aiheuttaa välittömän päivityksen. Kysymyksen tarkistuslippu (`needsReview`) poistettu.
- **050-0112 vastaus korjattu**: Oikea vastaus oli virheellisesti D. Korjattu vastaukseksi A: "Tasainen ilma, huono näkyvyys, sumua, matalaa stratus-pilvisyyttä ja kuurottaista sadetta." Selitys: pinnanläheinen inversio tekee ilmasta vakaata ja tasaista; korkealla kosteudella näkyvyys on usein huono ja voi muodostua sumua sekä matalaa stratuspilvisyyttä.
- **060-0007 vastaus korjattu**: Oikea vastaus oli virheellisesti C ("21 600 NM"). Korjattu vastaukseksi A: "40 075 km." Selitys: 21 600 NM perustuu 360° × 60 NM/aste -likiarvoon, mutta päiväntasaajan todellinen ympärysmitta on lähempänä 40 075 kilometriä.
- **060-0079 selitys korjattu**: Vastaus A oli jo oikein, mutta selitys viittasi virheellisesti eksymään. Korjattu: magneettinen ohjaussuunta saadaan tosiohjaussuunnasta huomioimalla magneettinen eranto; eksymä huomioidaan vasta kompassiohjaussuuntaa määritettäessä.
- **060-0103 vastaus ja selitys täydennetty**: Selitys oli aiemmin placeholder ("tarkista PDF:stä"). Oikea vastaus D: "Lennettäessä OBS-nupista valittua suuntimaa päinvastaiseen ohjaussuuntaan." Selitys: OR:n käänteinen näyttö syntyy, kun lennetään OBS:llä valittuun suuntaan nähden päinvastaiseen ohjaussuuntaan, jolloin CDI-neulan korjaussuunta on päinvastainen normaaliin nähden.
- **060-0118 vastaus korjattu**: Oikea vastaus oli virheellisesti D. Korjattu vastaukseksi B: "Ohjaaja, mutta ainoastaan maassa laitteen ollessa paikallaan." Selitys: reittipistetietokannan voi yleensä päivittää ohjaaja maassa valmistajan hyväksymällä päivityksellä; ei lennon aikana eikä normaalisti Part-145-huoltokorjaamon kautta.
- **060-0139 vastaus korjattu**: Oikea vastaus oli virheellisesti B. Korjattu vastaukseksi C: "Tuulikorjauskulma ja eranto." Selitys: magneettisessa ohjaussuunnassa on huomioitu tuulikorjauskulma sekä magneettinen eranto; tosilentosuunta on vain laskennan lähtösuunta.
- **070-0025 vastaus korjattu**: Oikea vastaus oli virheellisesti B ("10 000 ft"). Korjattu vastaukseksi D: "13 000 ft." Selitys: yli 13 000 ft lisähappea on käytettävä jatkuvasti; 10 000–13 000 ft korkeudessa olennaisen miehistön on käytettävä lisähappea, jos korkeudella oleskellaan yli 30 minuuttia.
- **080-0074 vastaus korjattu**: Oikea vastaus oli virheellisesti D. Korjattu vastaukseksi C: "On samansuuntainen linjan kanssa, joka kulkee painopisteen ja siipien kärkien kautta." Selitys: poikittaisakseli kulkee lentokoneen painopisteen kautta siivenkärkien suuntaisesti ja on kohtisuorassa pituusakseliin nähden; pituuskallistus (pitch) tapahtuu tämän akselin ympäri.
- **080-0086 vastaus korjattu**: Oikea vastaus oli virheellisesti A. Korjattu vastaukseksi B.
- **080-0088 vastaus korjattu**: Oikea vastaus oli virheellisesti D. Korjattu vastaukseksi A: "Nokkaylös-vaikutus on heikentynyt." Selitys: kun massakeskiö on lähellä sallittua eturajaa, tarvitaan enemmän nokka-ylös-trimmiä etupainoisuuden tasapainottamiseksi, jolloin käytettävissä oleva nokka-ylös-ohjausvara pienenee.
- **090-0017 vastaus korjattu**: Oikea vastaus oli virheellisesti C. Korjattu vastaukseksi B: "Kaarra oikeaan ja jatka sitä kunnes toisin ohjeistetaan." Selitys: "TEE YMPYRÄÄ OIKEALLE" vastaa ORBIT RIGHT -sanontaa, jossa ilma-alus jatkaa oikeanpuoleista ympyrää kunnes lennonjohto antaa uuden ohjeen; yksittäinen 360 asteen kaarto annetaan erillisellä sanonnalla "MAKE A THREE SIXTY TURN RIGHT".
- **090-0071 vastaus korjattu**: Oikea vastaus oli virheellisesti C. Korjattu vastaukseksi D: "PYSÄYTÄ NOUSU LENTOPINNALLA 80." Selitys: kun nousu FL100:lle halutaan keskeyttää väliaikaisesti FL80:een, lennonjohto käyttää sanontaa "PYSÄYTÄ NOUSU LENTOPINNALLA 80" (STOP CLIMB AT FL80).

### Muutettu
- **Vaalean teeman taustakuva vaihdettu**: Vaaleassa tilassa käytettiin aiemmin samaa `Taustakuva ISO.png` -kuvaa kuin tummassa tilassa (lähes näkymättömänä vaalean peittokerroksen alla). Vaalean tilan taustakuvaksi vaihdettu `VaaleaTausta.png`.

### Korjattu
- **Taustakuva ei näkynyt `PPL-harjoittelu.html`:ssä**: CSS:n taustakuvapolut (`url('../Taustakuva ISO.png')`, `url('../VaaleaTausta.png')`) oli kirjoitettu suhteessa `src/styles.css`-tiedoston sijaintiin. `index.html`:ssä tämä toimi, mutta yhden tiedoston `PPL-harjoittelu.html`:ssä tyyli on upotettu suoraan HTML:ään, jolloin selain tulkitsee polun suhteessa HTML-tiedoston (projektin juuren) sijaintiin — kuva osoitti siis juuren yläpuolelle eikä löytynyt. `tools/build_single_html.py` poistaa nyt automaattisesti CSS:n `../`-etuliitteen kuvapoluista upotettaessa, jolloin molemmat teemat näyttävät taustakuvan oikein sekä `index.html`:ssä että `PPL-harjoittelu.html`:ssä.
- **GitHub Pages -julkaisusta puuttui `VaaleaTausta.png`**: `.github/workflows/deploy.yml` kopioi julkaisuun vain `Taustakuva ISO.png`-tiedoston. Koska vaalea teema käyttää nyt `VaaleaTausta.png`-kuvaa, se olisi puuttunut tuotantojulkaisusta (404). Lisätty `cp "VaaleaTausta.png" dist/` julkaisuvaiheeseen.
